...
const GameItem = ({
  ...
  nivel,
    ...
    let color = '';
    switch(nivel){
      case 'Mediu': color = 'rgb(255, 204, 0)'; break;
      case 'Dificil': color = 'rgb(255, 102, 102)'; break;
      case 'Simplu': color = 'rgb(102, 255, 51)'; break;
    ...
    >
      ...
      <div className="game-item-characteristic nivel" style={{color: color, 'font-weight': 'bold'}}>{nivel}</div>
